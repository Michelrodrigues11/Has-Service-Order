...
namespace Has_Service_Order.Tests.Services
{
    public class CommentsServiceTest
    {
        ...
        {
            new Comment { Id = 1, Description = "Teste Comentario", SendDate = DateTimeOffset.Now, ServiceOrderId = serviceOrderId }
        };
        ...
        {
            new CommentDto(1, "Teste Comentario", DateTimeOffset.Now, serviceOrderId)
        };
